  ...
  return (
    <div className="w-full">
     <div className="w-full h-64 md:w-1/2 lg:h-96 relative">
        <Image
          ...
          alt={outfit.outfit_array.outfit_name  || "No outfit Name"}
          layout="fill"
          objectFit="cover"
    ...
    <div className="md:flex">
      ...
      <div className="w-full  mx-auto mt-5 md:ml-8 md:mt-0">
        <h3 className="text-gray-700 uppercase text-lg">{outfit.outfit_array.outfit_name || "No Outfit Name"}</h3>
        <div className="text-gray-300 mt-3">{outfit.outfit_array.gpt_response || "No outfit description"}</div>
        <hr className="my-3" />
        <div className="mt-2">
